 ...
 * \param
 */
void function_minimizer::quasi_newton_block(int nvar,int _crit,independent_variables& x,const dvector& _g,const double& _f,VEC * (*model)(VEC *,VEC *,Real *,Parameters *),VEC *me_x,Parameters * parameters)
{
  int ifn_trap=0;
  int itn_trap=0;
  int on=0;
