...
double themodeli(double, void *,MAT *,MAT *,MAT *,MAT *,VEC *,VEC *,MAT *,MAT *,IVEC *);
double themodelid(double,void *,MAT *,MAT *,MAT *,MAT *,VEC *,VEC *,MAT *,MAT *,IVEC *);
	    ...
	    )
{
  ...
  for (int i=0;i<20;i++)
      ...
      for (int j=-2;j<10;j++) 
	{
	  ...
	  double f1 = themodeli(iota+delta,(void *)&tmi,x,u,xh,uh,Ui,Uh,xn,un,idxi);
