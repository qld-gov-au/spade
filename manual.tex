...
New birth equation:
\begin{equation}
  b(x) = \alpha \left(8.588e-5 x + 0.00144 x^2\right)
\end{equation}
...
\kappa\omega p(0,t) &= \int_0^\omega \left(8.588e-5 x + 0.00144 x^2\right) p(x,t)\,dx
  \end{split}
\end{equation}

%//  \frac{d F}{d \alpha_2} &= p_t + \kappa(\omega-x)p_x - \kappa p +
